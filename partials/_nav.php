...
<span itemprop="name">PROCESS | UTILITIES</span></span>
     ...
     <div class="navbar-collapse collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a itemprop="url" data-toggle="collapse" data-target=".navbar-collapse" href="index.php"><span class="sr-only">Toggle navigation</span><i class="icon icon-home"></i></a></li>
