    ...
    <div class="row">
          <div id="mc_embed_signup" class="center-block">
            ...
            <div style="position: absolute; left: -5000px;">
                <label for="mc-misc"><span class="sr-only">Mail chimp required</span>
                    <input type="text" name="b_4c4c85231a21cffb5dd577d3e_2523429788" tabindex="-1" value="" id="mc-misc">
                </label>
            </div>
            <div class="clear"><label for="mc-embedded-subscribe"><span class="sr-only">Submit Button</span><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></label></div>
        </form>
      </div>
